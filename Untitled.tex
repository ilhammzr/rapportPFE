...
\begin{figure}[H]
\centering
\includegraphics[scale=1]{ca.png}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.45]{dec.png}
...
\begin{enumerate}[label=(\alph*)]
\item {Compte}Les comptes sont les sociétés avec lesquelles nous somme en affaire.
\item{Contact}
...
Voici certaines des étapes par lesquelles on passe  habituellement :
		...
		\end{itemize}
\item{Contact}
Les contacts sont créés dès qu'une piste exprime un intérêt pour faire des affaires. La piste est convertie en un contact. Les contacts sont les personnes qui appartiennent aux comptes (entreprises) et envisagent de passer par une transaction.
Les rôles des contacts des opportunités indiquent avec quels contacts on fait l'affaire pour l'opportunité et comment chaque contact est lié à l'opportunité. Les rôles de contact permettent également de lier des contacts d'autres comptes à l'opportunité.



\item{Piste }:piste dans salesforce.com sont ceux qui nous somme intéressé à travailler avec, mais on ne sait pas s'ils sont intéressés à travailler avec nous.
\paragraph{}
