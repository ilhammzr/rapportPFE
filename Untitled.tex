...
\paragraph{}
Ce diagramme permet aussi de visualiser l'enchainement et la durée des différentes tâches durant la réalisation du projet comme il est illustré dans les figures qui suivent :
...
\paragraph{}
On commence à developper les fonctionnalitées demandées avec les tests en parallèle, une fois les objectif de l'iteration atteints  on fait un démo des fonctionnalités developpées.
\paragraph{}
