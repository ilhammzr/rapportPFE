...
%---------------- MOOOOOOOOOOOMO 
    ...
    {0.5pc}
    {\vspace{0.5pc}\Huge#1}%
    \titlespacing{\chapter}{0pt}{3\baselineskip}{4\baselineskip}
    ...
    [\ifbool{addtoc}{\addcontentsline{toc}{chapter}{#1}}]%
     \titlespacing{name = \chapter, numberless}{0pt}{2\baselineskip}{5\baselineskip}
...
Les consommateurs aujourd'hui habitués à avoir le choix et l'accès à des produits de qualité portent une attention grandissante à des aspects autrefois relégués au second plan. Lors de son processus d'achat, le consommateur recherche des aspects comme le plaisir, la sécurité, la considération et la personnalisation. Ces nouveaux critères obligent les entreprises à mettre en place les processus nécessaires à la rencontre de ces attentes. C'est ce qui explique l'implantation accélérée de solutions visant la Gestion des Relations Client ou la "Customer Relationship Management" (CRM). 
 ...
 \paragraph{}
La mise en place d'un CRM redonne de la visibilité et de la sérénité car il répond aux besoins actuels. Il structure, partage et distille l'information appropriée pour tous les services (marketing, commercial, administratif, technique et support). Cette centralisation est facilitée par la réalisation de nombreuses actions marketing et par l'intégration de différents services comme l'accès à la boite mail et aux divers documents électroniques.
...
\paragraph{}
Un système informatique de BPM permet la conception, l'analyse,  l'optimisation et l'automatisation  des  processus  business.  Pour y parvenir,  il  sépare  la  logique  du  processus  des  
...
\subsubsection{	Réalisation} la réalisation s'est déroulée sur plusieurs étapes, selon les processus détérminés pendant la phase de la conception initiale.
\paragraph{}
...
\subsection {la philosophie de Salesforce}
...
\subsubsection {Compte}Les comptes sont les sociétés avec lesquelles nous somme en affaire.
...
Piste (Lead):piste dans salesforce.com sont ceux qui nous somme intéressé à travailler avec, mais on ne sait pas s'ils sont intéressés à travailler avec nous.
\paragraph{}
...
%-_-_-_-_-_-_-_-_-_ Analyse Fonctionnelle et Conception-_-_-_-_-
