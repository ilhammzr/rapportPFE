...
\addcontentsline{toc}{chapter}{\textsc{Abstract}}
 ...
 \paragraph{}
This report summarizes the work that I have done during my period of internship at the end of studies within the consultant firm \textbf{Neoxia Morocco}, a privileged integrator partner of Salesforce, established in Casablanca.

 \paragraph{}
In order to increase its productivity and profit while reducing time and budgets, and to improve its performance and competitive position, Neoxia has put the client satisfaction as the center of attention.
That's why Neoxia has invested to create a CRM solution to manage its own commercial process.

 \paragraph{}
We had the mission off setting in place an application with the purpose of helping Neoxia to improve their performance and their competitive position. The issue was mainly on the configuration of the Salesforce CRM solution to achieve a process that automates and increases sales by considerably facilitating the task, accelerating the process of sale, monitoring the different projects and postings, and finally, the billing management.

 \paragraph{}
To do this, we started by conducting an detailed analyze then a full conception of the solution, to define all the functionalities that they need or desire to put in place, afterwards, we modelized all the specific needs, and decided which processes to adopt, and then a long phase of realization and continuous validation took place.

\paragraph{}
The application is modeled with the help of the BPM Bizagi, and developed by specific tools to the Force.com platform: the Apex language, the Visualforce Framework and SOQL, which enables the interaction with the database.
\newline
\newline
\newline
 \paragraph{}
